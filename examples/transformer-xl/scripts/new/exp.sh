...
SAVE_DIR=Layer4_Experts16_${GATE_NAME}_ALL_${Dynamic_mode}_${Dynamic_steps}_${DATE}
CUDA_VISIBLE_DEVICES=0,1 nohup bash scripts/new/layer4_experts16_moe_freeze_router.sh \
...
CUDA_VISIBLE_DEVICES=2,3 nohup bash scripts/new/layer4_experts16_moe_freeze_router.sh \
    ${GATE_NAME} ${MoE_INDEX} ${Dynamic_mode} ${Dynamic_steps} ${SAVE_DIR} > log_${DATE}_${SAVE_DIR}.out 2>&1 &
