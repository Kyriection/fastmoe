...
key=layer4_experts16_moe_random_late-enwik8
CUDA_VISIBLE_DEVICES=0 nohup bash scripts/part_moe/layer4_eval.sh CustomRandomGate ${key} 3 > log_EVAL_${key}.out 2>&1 &
key=layer4_experts16_moe_random_early-enwik8
CUDA_VISIBLE_DEVICES=1 nohup bash scripts/part_moe/layer4_eval.sh CustomRandomGate ${key} 0 > log_EVAL_${key}.out 2>&1 &
key=layer4_experts16_moe_naive_late-enwik8
CUDA_VISIBLE_DEVICES=2 nohup bash scripts/part_moe/layer4_eval.sh CustomNaiveGate ${key} 3 > log_EVAL_${key}.out 2>&1 &
key=layer4_experts16_moe_naive_freeze_middle1-enwik8
CUDA_VISIBLE_DEVICES=3 nohup bash scripts/part_moe/layer4_eval.sh CustomNaiveGate ${key} 1 > log_EVAL_${key}.out 2>&1 &
key=layer4_experts16_moe_naive_freeze_late-enwik8
CUDA_VISIBLE_DEVICES=0 nohup bash scripts/part_moe/layer4_eval.sh CustomNaiveGate ${key} 3 > log_EVAL_${key}.out 2>&1 &
key=layer4_experts16_moe_naive_freeze_every2-enwik8
CUDA_VISIBLE_DEVICES=1 nohup bash scripts/part_moe/layer4_eval.sh CustomNaiveGate ${key} 1,3 > log_EVAL_${key}.out 2>&1 &
key=layer4_experts16_moe_naive_freeze_early-enwik8
CUDA_VISIBLE_DEVICES=2 nohup bash scripts/part_moe/layer4_eval.sh CustomNaiveGate ${key} 0 > log_EVAL_${key}.out 2>&1 &
key=layer4_experts16_moe_naive_early-enwik8
CUDA_VISIBLE_DEVICES=3 nohup bash scripts/part_moe/layer4_eval.sh CustomNaiveGate ${key} 0 > log_EVAL_${key}.out 2>&1 &
