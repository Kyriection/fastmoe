...
from mem_transformer_block import MemTransformerLM, set_block_size, set_drop_prob, calculate_drop_prob
...
set_block_size(model, 5)
set_drop_prob(model, 0)
...
def train():
    ...
    for batch, (data, target, seq_len) in enumerate(train_iter):
        ...
        current_drop_prob = calculate_drop_prob(train_step, args.max_step, 0, 0.05)
        set_drop_prob(model, current_drop_prob)
